...
function Get-ConfigurationFile{
    ...
    $myConfig | ForEach-Object {
       ...
       Set-ItemProperty -Path ($strPlayListParentDir + '\Playlist\myConfigVM.txt') -Name IsReadOnly -Value $true
...
function Edit-ConfigFile{
    param(
     ...
     $strName = ""
     $strFile = ($FullPathToSoundFiles + "\Playlist\myConfigVM.txt")
...
$strConfigGlobal = ($strConfigGlobal.ToString() +"\Playlist\myconfigVM.txt")
